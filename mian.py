...
"}")
        ...
        self.DrumbButton.setGeometry(QtCore.QRect(680, 80, 111, 111))
...
"")
        ...
        self.label_for_drumb_picture.setGeometry(QtCore.QRect(600, 50, 251, 161))
        ...
        self.verticalSlider_For_volume.setSliderPosition(5)
...
######## End Spec
    ...
    def pb1(self):
        if self.comboBox_for_tunes.currentIndex() == 0:
            ...
            winsound.Beep(210,980)
        else:
            winsound.Beep(330,1100)
    def pb2(self):
         if self.comboBox_for_tunes.currentIndex()==0:
             winsound.Beep(821, 870)
         elif self.comboBox_for_tunes.currentIndex() == 1:
             winsound.Beep(230,980)
         else:
            winsound.Beep(350,1150)
    def pb3(self):
         if self.comboBox_for_tunes.currentIndex()==0:
             winsound.Beep(731, 820)
         elif self.comboBox_for_tunes.currentIndex() == 1:
             winsound.Beep(250, 980)
         else:
             winsound.Beep(370, 1150)
    def pb4(self):
         if self.comboBox_for_tunes.currentIndex()==0:
             winsound.Beep(650, 730)
         elif self.comboBox_for_tunes.currentIndex() == 1:
             winsound.Beep(270, 980)
         else:
             winsound.Beep(390, 1150)
    def pb5(self):
         if self.comboBox_for_tunes.currentIndex()==0:
             winsound.Beep(611, 650)
         elif self.comboBox_for_tunes.currentIndex() == 1:
             winsound.Beep(290, 980)
         else:
             winsound.Beep(410, 1150)
    def pb6(self):
         if self.comboBox_for_tunes.currentIndex()==0:
             winsound.Beep(581, 611)
         elif self.comboBox_for_tunes.currentIndex() == 1:
             winsound.Beep(310, 980)
         else:
             winsound.Beep(430, 1150)
    def pb7(self):
        if self.comboBox_for_tunes.currentIndex()==0:
            winsound.Beep(550, 580)
        elif self.comboBox_for_tunes.currentIndex() == 1:
            winsound.Beep(330, 980)
        else:
            winsound.Beep(450, 1150)
    def pb8(self):
         if self.comboBox_for_tunes.currentIndex()==0:
    ...
    def pb10(self):
         if self.comboBox_for_tunes.currentIndex()==0:
             ...
             winsound.Beep(380, 1250)
    def pb11(self):
        if self.comboBox_for_tunes.currentIndex()==0:
            winsound.Beep(690, 770)
        elif self.comboBox_for_tunes.currentIndex() == 1:
            winsound.Beep(280, 1000)
        else:
            winsound.Beep(400, 1250)
    def pb12(self):
         if self.comboBox_for_tunes.currentIndex()==0:
             ...
             winsound.Beep(420, 1250)
    def g1(self):
        pygame.mixer.music.load('Guitar/GTR1.wav')
        pygame.mixer.music.play()
    def g2(self):
        pygame.mixer.music.load('Guitar/cleanmidbass-E01-slap.wav')
        pygame.mixer.music.play()
    def g3(self):
